...
const PostModal = () => {
    ...
    return (
        <div>
            <Button type="primary" shape="round" onClick={openModal}><b>Create Post</b></Button>
            <Modal
                show={visible}
                onHide={handleClose}
            >
                ...
                <Modal.Body>
                    <FormControl as="textarea" aria-label="Post area" rows={5} placeholder={`What is going on, ${'Andressa'}?`} />
                </Modal.Body>
                <Modal.Footer>
